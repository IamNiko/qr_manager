...
const unsigned long TIMEOUT_SEGUNDA_VALIDACION = 30000;  // 30 segundos para ingresar importe
    ...
    if (!error) {
      ...
      if (valido) {
        ...
        if (estadoActual == ESPERANDO_QR) {
          ...
          Serial.println("Segunda validación - Crédito Disponible: $" + String(credito));
